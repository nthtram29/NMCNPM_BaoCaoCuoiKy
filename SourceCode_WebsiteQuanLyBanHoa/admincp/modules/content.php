    	...
    	<div class="box_contains">
        	<?php
				if(isset($_GET['quanly'])&&$_GET['ac']){
					...
					$tam1=$_GET['ac'];
					...
					}elseif(($tam == 'kichcosp')&&($tam1 == 'them')){
						
						include('modules/quanlykichcosp/them.php');
					}elseif(($tam == 'kichcosp')&&($tam1 == 'lietke')){
						
						include('modules/quanlykichcosp/lietke.php');
					}elseif(($tam == 'kichcosp')&&($tam1 == 'sua')){
						
						include('modules/quanlykichcosp/sua.php');
						...
						include('modules/hoadon/chitiet.php');
