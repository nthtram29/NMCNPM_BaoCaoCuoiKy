<?php
	$sql=mysqli_query($mysqli,"SELECT * from sanpham where idsanpham='$_GET[id]'");
...
<table width="100%" border="1">
  ...
  <tr>
    ...
    <td>
    <?php
	$sql_gal=mysqli_query($mysqli,"SELECT hinhanhsp from gallery where id_sp='$_GET[id]'");
    ...
    <?php
		...
		echo 'Chưa có hình ảnh sản phẩm. Làm ơn Thêm Gallery';
	}
	?>
    </td>
